...
-- MENU --
local mainMenu = RageUI.CreateMenu("Blanchiment", "Angel Dev")
     ...
     if open then 
         ...
         while open do 
            ...
            RageUI.IsVisible(mainMenu,function() 
				...
				RageUI.Button("Blanchir de l'argent", "Pedro prend ~r~35% du blanchiment !", {RightLabel = "→→→"}, true , {
					onSelected = function()
						local argent = KeyboardInput("Combien d'argent(s) Sale(s) as-tu ?", '' , '', 8)
						TriggerServerEvent('Angel:blanchiment', argent)	
					end
				})
